...
UCLASS()
class THELASTTOWER_API AProjectile : public AActor
{
	GENERATED_BODY()

	TEnumAsByte<ECollisionChannel> COLLISION_ENEMY		{ ECC_GameTraceChannel2 };
	TEnumAsByte<ECollisionChannel> COLLISION_PROJECTILE{ ECC_GameTraceChannel4 };
...
public:	
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite)	class AActor*				Target;
